...
// let n = prompt("Enter a number?")-0; //convert to number
// for (let i = 0; i < n; i++) {
//   console.log(i);
// }

//c.A sequence of numbers, starting from 3, ending before n, n entered by user
// let n = prompt("Enter n")-0; //convert to number
// for (let i = 3; i < n; i++) {
//   console.log(i);
// }
...
// let n = prompt("Enter n")-0; //convert to number
// let c = prompt("Enter c")-0; //convert to number
// for (let i = c; i < n; i++) {
//   console.log(i);
// }
...
// let n = prompt("Enter n") - 0; //convert to number
// let c = prompt("Enter c") - 0; //convert to number
// let s = prompt("Enter s") - 0; //convert to number
// for (let i = c; i < n; i += s) {
//   console.log(i);
// }
...
// let inputAge = prompt("How old are you?")-0;
// if (inputAge >= 14) {
//   alert("Enjoy!");
// } else {
...
// while (x < 0 || x > 9) {
//   x = prompt("Enter a number in range 0-9");
// }
// if (x >= 0 && x < 4.5) {
...
// let inputNum = prompt("Enter the total number of L's and H's") - 0;
...
// let inputNum = prompt("Enter the total number of 1's and 0's");
...
// let yourWeight = prompt("Your weight in kg");
// let yourHeight = prompt("Your height in cm") / 100;
// let BMI = (yourWeight / yourHeight ** 2).toFixed(2);
